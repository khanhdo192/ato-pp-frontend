...
export default function TableRowProjectLog({data, statusId}) {
  ...
  return (
      <div className="relative grid grid-cols-2 lg:grid-cols-log-table gap-1.5 lg:gap-0  items-center text-sm  lg:text-xs text-gr-700 pt-10 pb-4 lg:py-2.5
